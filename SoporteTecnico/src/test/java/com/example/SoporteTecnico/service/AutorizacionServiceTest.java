...
public class AutorizacionServiceTest {
    ...
    @Mock
    private UsuarioUser usuarioClient;
    @InjectMocks
    ...
    void obtenerRolUsuarioConectado_devuelveRolCorrectamente() {
        ...
        // simulamos respuesta directa de WebClient ya resuelta
        Map<String, Object> usuarioMap = new HashMap<>();
        usuarioMap.put("idRol", 3);
        when(usuarioClient.getUsuarioPorId(100)) // ahora devuelve directamente el Map, no Optional
                .thenReturn(usuarioMap); // ya no es Optional.of
